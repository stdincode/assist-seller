...
interface ConsultationRequestsBagInterface
{
    /**
    ...
    /**
     * @param AbstractConsultationRequest $consultationRequest
     * @return void
     */
    public function add(AbstractConsultationRequest $consultationRequest): void;
